...
type ViewState = 'dashboard' | 'talent-id' | 'talent-mapping' | 'global-mapping' | 'report' | 'match-analysis' | 'bd-scout' | 'bd-talentos' | 'global-database' | 'agenda' | 'profile' | 'admin' | 'report-history';
